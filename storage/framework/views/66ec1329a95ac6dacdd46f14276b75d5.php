<?php $__env->startSection('content'); ?>
    ...
    <div class="flex w-full justify-between py-10 px-40">
        <div class="flex flex-col w-1/2 items-start">
            <img src="<?php echo e(asset('assets/frontend-image/service-image/auditing-icon.png')); ?>" class="w-1/2 object-cover"
                alt="" />
        </div>
    ...
    <div class="flex w-full justify-between px-40 py-20">
        ...
        <div class="flex flex-col w-1/2">
            <img src="<?php echo e(asset('assets/frontend-image/service-image/auditing-serve.png')); ?>" class="w-full object-cover"
                alt="" />
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('frontend.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yahyazackys/Dev/backend/hayed-backend/resources/views/frontend/service/auditing.blade.php ENDPATH**/ ?>