    ...
    <div class="swiper-container w-full h-screen overflow-hidden">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide relative">
                <img src="<?php echo e(asset('assets/frontend-image/article-bg.svg')); ?>" class="w-full h-full object-cover"
                    alt="Slide 1">
        ...
        <div class="flex flex-col w-full">
            ...
            <div class="flex flex-row mt-8 justify-between">
                <a href="#"
                    ...
                    <img src="<?php echo e(asset('assets/frontend-image/article-breaking.svg')); ?>" class="w-full" alt="">
        ...
        <div class="flex flex-col max-w-[650px]">
            <div class="flex justify-between w-full mb-8">
                ...
                <div class="relative">
                    <div id="categoryDropdown" class="flex gap-x-2 items-center cursor-pointer group">
                        <img src="<?php echo e(asset('assets/frontend-image/sort.png')); ?>" class="w-5" alt="">
            ...
            <div class="flex flex-col gap-y-8">
                <a href="" class="flex w-full text-black gap-x-5 group">
                    <div class= "w-80">
                        <img src="<?php echo e(asset('assets/frontend-image/article-feed.svg')); ?>" class="object-contain"
                            alt="">
                    </div>
...
<?php echo $__env->make('frontend.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yahyazackys/Dev/backend/hayed-backend/resources/views/frontend/article.blade.php ENDPATH**/ ?>