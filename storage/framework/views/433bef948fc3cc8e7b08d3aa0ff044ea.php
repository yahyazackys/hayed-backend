<?php $__env->startSection('content'); ?>
    <div class="swiper-container w-full h-screen overflow-hidden">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <img src="<?php echo e(asset('assets/frontend-image/bg.png')); ?>" class="w-full h-full object-cover" alt="Slide 2">
            </div>
            <div class="swiper-slide">
                <img src="<?php echo e(asset('assets/frontend-image/bg.png')); ?>" class="w-full h-full object-cover" alt="Slide 3">
            </div>
        </div>
        <!-- Add Pagination -->
...
<?php echo $__env->make('frontend.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/hayed-company/resources/views/frontend/home.blade.php ENDPATH**/ ?>