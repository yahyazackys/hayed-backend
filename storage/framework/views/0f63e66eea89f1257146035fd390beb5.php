                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description">
                            <a href="<?php echo e(route('consultant')); ?>" class="btn btn-sm btn-primary">Kembali</a>
                        </p>
                        <?php if($errors->any()): ?>
                        ...
                        <?php endif; ?>
                        <form class="forms-sample" action="<?php echo e(route('consultant-store')); ?>" method="POST"
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_asli"
                                            class="form-control <?php $__errorArgs = ['nama_asli'];
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_gelar"
                                            class="form-control <?php $__errorArgs = ['nama_gelar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group col-xs-12">
                                            <input type="file" name="gambar_nonbg"
                                                class="btn btn-primary <?php $__errorArgs = ['gambar_nonbg'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group col-xs-12">
                                            <input type="file" name="gambar_bg"
                                                class="btn btn-primary <?php $__errorArgs = ['gambar_bg'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        var loadFile = function(event) {
            var output = document.getElementById('preview-image2');
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yahyazackys/Dev/backend/hayed-backend/resources/views/consultant/create.blade.php ENDPATH**/ ?>