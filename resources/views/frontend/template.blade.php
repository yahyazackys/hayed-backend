    ...
    <nav class="bg-white shadow-md border-gray-200 fixed top-0 w-full z-50 py-6">
        <div class="max-w-screen-xl flex items-center justify-between mx-auto px-4">
            ...
            <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="{{ asset('assets/frontend-image/logo.png') }}" class="w-40" alt="Hayed Logo" />
            </a>
                ...
                <ul
                    ...
                    <li>
                        ...
                        <div id="dropdownNavbar"
                            ...
                            <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                                <li>
                                    <a href="{{ route('vision-mission-value') }}"
                    ...
                    <li>
                        ...
                        <div id="dropdownNavbar2"
                                            ...
                                            @foreach ($servis as $service)
                                                <li>
                                                    <a href="{{ route('service.show', $service->id) }}"
                                                        class="block px-4 py-2 hover:bg-gray-100 text-black text-[16px]">{{ $service->servis }}</a>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </div>
                            ...
                            {{-- <div class="py-1">
                                <a href="#"
                                    class="text-lg block px-4 py-2 text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Sign
                                    out</a>
                            </div> --}}
                        </div>
                    </li>
    ...
    <footer id="footer"
        ...
        <div class="flex flex-col lg:flex-row justify-between w-full items-center">
            <div class="flex flex-col">
                <img src="{{ asset('assets/frontend-image/logo-white.png') }}" class="w-60 text-white"
                    alt="Hayed Logo" />
            </div>
            <div class="flex flex-col gap-y-8 w-[50%]">
                ...
                <div class="flex flex-col gap-y-10 font-medium">
                    <div class="flex items-center gap-x-3">
                        <x-go-location-16 class="w-6 text-white" />
