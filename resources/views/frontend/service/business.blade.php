...
@section('content')
    ...
    <div class="flex w-full justify-between py-10 px-40">
        <div class="flex flex-col w-1/2 items-start">
            <img src="{{ asset('assets/frontend-image/service-image/business-icon.png') }}" class="w-1/2 object-cover"
                alt="" />
        </div>
    ...
    <div class="flex w-full justify-between px-40 py-20">
        ...
        <div class="flex flex-col w-1/2">
            <img src="{{ asset('assets/frontend-image/service-image/business-serve.png') }}" class="w-full object-cover"
                alt="" />
        </div>
    </div>
@endsection
