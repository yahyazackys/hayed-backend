...
@section('content')
    <div class="swiper-container w-full h-screen overflow-hidden">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <img src="{{ asset('assets/frontend-image/bg.png') }}" class="w-full h-full object-cover" alt="Slide 2">
            </div>
            <div class="swiper-slide">
                <img src="{{ asset('assets/frontend-image/bg.png') }}" class="w-full h-full object-cover" alt="Slide 3">
            </div>
        </div>
        <!-- Add Pagination -->
