                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description">
                            <a href="{{ route('service') }}" class="btn btn-sm btn-primary">Kembali</a>
                        </p>
                            ...
                            <div class="row mt-3">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="servis" class="form-control" placeholder="Servis...">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <label for="exampleInputSpesifikasi4">Pengertian</label>
                                        <input type="text" name="pengertian" class="form-control" placeholder="Pengertian...">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
